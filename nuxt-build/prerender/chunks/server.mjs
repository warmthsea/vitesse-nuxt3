...
import { hasProtocol, joinURL, isEqual, withBase, withQuery } from 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/ufo@0.8.5/node_modules/ufo/dist/index.mjs';
import { defineStore, createPinia, setActivePinia } from 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/pinia@2.0.14_typescript@4.7.4/node_modules/pinia/dist/pinia.mjs';
import { u as useRuntimeConfig$1 } from './nitro-prerenderer.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/h3@0.7.10/node_modules/h3/dist/index.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/unenv@0.5.2/node_modules/unenv/runtime/mock/proxy.mjs';
import 'stream';
...
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/ohmyfetch@0.4.18/node_modules/ohmyfetch/dist/node.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/destr@1.1.1/node_modules/destr/dist/index.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/radix3@0.1.2/node_modules/radix3/dist/index.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/unenv@0.5.2/node_modules/unenv/runtime/fetch/index.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/hookable@5.1.1/node_modules/hookable/dist/index.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/scule@0.2.1/node_modules/scule/dist/index.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/ohash@0.1.0/node_modules/ohash/dist/index.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/unstorage@0.5.4/node_modules/unstorage/dist/index.mjs';
import 'file://V:/GitHub/vitesse-nuxt3/node_modules/.pnpm/unstorage@0.5.4/node_modules/unstorage/dist/drivers/fs.mjs';
...
function normalizePlugins(_plugins2) {
  ...
  const plugins2 = _plugins2.map((plugin2) => {
    ...
    if (isLegacyPlugin(plugin2)) {
      needsLegacyContext = true;
      return (nuxtApp) => plugin2(nuxtApp._legacyContext, nuxtApp.provide);
    }
    return plugin2;
  });
...
function isLegacyPlugin(plugin2) {
  return !plugin2[NuxtPluginIndicator];
}
...
const toDisplayString = (val) => {
  return isString(val) ? val : val == null ? "" : isArray$2(val) || isObject$2(val) && (val.toString === objectToString$1 || !isFunction$1(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
};
...
const components = {};
function V_58_47GitHub_47vitesse_45nuxt3_47nuxt_45build_47components_46plugin_46mjs(nuxtApp) {
...
const V_58_47GitHub_47vitesse_45nuxt3_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_464_sass_641_4653_460_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin = defineNuxtPlugin((nuxtApp) => {
...
const V_58_47GitHub_47vitesse_45nuxt3_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_464_sass_641_4653_460_47node_modules_47nuxt_47dist_47head_47runtime_47plugin = defineNuxtPlugin((nuxtApp) => {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        "inline-flex": "",
        m: "y-3"
      }, _attrs))}><button btn p-2 rounded-full><div i-carbon-subtract></div></button><div font="mono" w="15" m-auto inline-block>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(count))}</div><button btn p-2 rounded-full><div i-carbon-add></div></button></div>`);
    };
  }
});
...
const useUserStore = defineStore("user", () => {
  const savedName = vue_cjs_prod.ref("");
  const previousNames = vue_cjs_prod.ref(/* @__PURE__ */ new Set());
  const usedNames = vue_cjs_prod.computed(() => Array.from(previousNames.value));
  const otherNames = vue_cjs_prod.computed(() => usedNames.value.filter((name) => name !== savedName.value));
...
const _sfc_main$g = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Counter = _sfc_main$h;
      const _component_NuxtLink = __nuxt_component_0$3;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><div i-twemoji:waving-hand text-4xl inline-block animate-shake-x animate-duration-5000></div><h3 text-2xl font-500> Hi, </h3><div text-xl>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(name))}! </div>`);
      if (vue_cjs_prod.unref(user).otherNames.length) {
        _push(`<p text-sm my-4><span op-50>Also as known as:</span><ul><!--[-->`);
        serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(user).otherNames, (otherName) => {
          _push(`<li>`);
          _push(serverRenderer.exports.ssrRenderComponent(_component_router_link, {
            ...
            default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`${serverRenderer.exports.ssrInterpolate(otherName)}`);
              } else {
                return [
                  vue_cjs_prod.createTextVNode(vue_cjs_prod.toDisplayString(otherName), 1)
                ];
              }
            }),
            _: 2
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_Counter, null, null, _parent));
      _push(`<div>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              vue_cjs_prod.createTextVNode(" Back ")
            ];
          }
        }),
        _: 1
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    ...
    "font-300": "",
    "cursor-default": ""
  }, _attrs))}><div flex flex-col children:mx-auto><img w-18 h-18 inline-block${serverRenderer.exports.ssrRenderAttr("src", _imports_0)}><span text-green5 mt--2>Nuxt 3</span></div><div text="3xl gray4" m="x-4 y-auto" transition-all-500 transform hover:rotate-135 i-carbon-add></div><div flex flex-col children:mx-auto><img w-18 h-18 inline-block${serverRenderer.exports.ssrRenderAttr("src", _imports_1)}><span text-purple5 mt--2>Vitesse</span></div></div>`);
}
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$4]]);
...
function useIntervalFn(cb, interval = 1e3, options = {}) {
  ...
  function resume() {
    if (vue_cjs_prod.unref(interval) <= 0)
      return;
    isActive.value = true;
...
const _sfc_main$e = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("/api/pageview")), __temp = await __temp, __restore(), __temp);
    const time = useTimeAgo(vue_cjs_prod.computed(() => data.value.startAt));
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ "text-gray:80": "" }, _attrs))}><span font-500 text-gray>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(data).pageview)}</span> page views since <span text-gray>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(time))}</span></div>`);
    };
  }
});
...
const _sfc_main$d = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    useRouter();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><input id="input"${serverRenderer.exports.ssrRenderAttr("value", name.value)} placeholder="What&#39;s your name?" type="text" autocomplete="off" p="x-4 y-2" m="t-5" w="250px" text="center" bg="transparent" border="~ rounded gray-200 dark:gray-700" outline="none active:none"><div><button m-3 text-sm btn${serverRenderer.exports.ssrIncludeBooleanAttr(!name.value) ? " disabled" : ""}> GO </button></div></div>`);
    };
  }
});
...
const routes = [
  {
    name: "404",
    path: "/:catchAll(.*)*",
    file: "V:/GitHub/vitesse-nuxt3/pages/404.vue",
    children: [],
    meta: meta$2,
    alias: [],
  ...
  },
  {
    name: "hi-id",
    path: "/hi/:id",
    file: "V:/GitHub/vitesse-nuxt3/pages/hi/[id].vue",
    children: [],
    meta: meta$1,
  ...
  },
  {
    name: "index",
    path: "/",
    file: "V:/GitHub/vitesse-nuxt3/pages/index.vue",
    children: [],
    meta,
    alias: [],
    component: () => Promise.resolve().then(function() {
...
const V_58_47GitHub_47vitesse_45nuxt3_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_464_sass_641_4653_460_47node_modules_47nuxt_47dist_47pages_47runtime_47router = defineNuxtPlugin(async (nuxtApp) => {
...
const V_58_47GitHub_47vitesse_45nuxt3_47node_modules_47_46pnpm_47_64nuxtjs_43color_45mode_643_461_464_47node_modules_47_64nuxtjs_47color_45mode_47dist_47runtime_47plugin_46server = defineNuxtPlugin((nuxtApp) => {
...
const V_58_47GitHub_47vitesse_45nuxt3_47nuxt_45build_47unocss_46mjs = () => {
};
...
function ssrAdapter(id, style2) {
  const ssrContext = vue_cjs_prod.inject(ssrContextKey, null);
  if (ssrContext === null) {
...
function useSsrAdapter() {
  const context = vue_cjs_prod.inject(ssrContextKey, null);
  if (context === null)
    return void 0;
  return {
    adapter: ssrAdapter,
...
const V_58_47GitHub_47vitesse_45nuxt3_47plugins_47naive_45ui_46ts = defineNuxtPlugin((nuxtApp) => {
  var _a;
  {
    const { collect } = setup(nuxtApp.vueApp);
    const originalRenderMeta = (_a = nuxtApp.ssrContext) == null ? void 0 : _a.renderMeta;
    nuxtApp.ssrContext = nuxtApp.ssrContext || {};
...
const _plugins = [
  preload,
  V_58_47GitHub_47vitesse_45nuxt3_47nuxt_45build_47components_46plugin_46mjs,
  V_58_47GitHub_47vitesse_45nuxt3_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_464_sass_641_4653_460_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin,
  V_58_47GitHub_47vitesse_45nuxt3_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_464_sass_641_4653_460_47node_modules_47nuxt_47dist_47head_47runtime_47plugin,
  V_58_47GitHub_47vitesse_45nuxt3_47node_modules_47_46pnpm_47nuxt_643_460_460_45rc_464_sass_641_4653_460_47node_modules_47nuxt_47dist_47pages_47runtime_47router,
  V_58_47GitHub_47vitesse_45nuxt3_47node_modules_47_46pnpm_47_64nuxtjs_43color_45mode_643_461_464_47node_modules_47_64nuxtjs_47color_45mode_47dist_47runtime_47plugin_46server,
  PiniaNuxtPlugin,
  V_58_47GitHub_47vitesse_45nuxt3_47nuxt_45build_47unocss_46mjs,
  V_58_47GitHub_47vitesse_45nuxt3_47plugins_47naive_45ui_46ts
];
const _sfc_main$c = {
  __name: "error-404",
  __ssrInlineRender: true,
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.0.0-rc.4_sass@1.53.0/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.0.0-rc.4_sass@1.53.0/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
function ensureValidVNode(vnodes) {
  return vnodes.some((child) => {
    if (!vue_cjs_prod.isVNode(child)) {
      return true;
    }
    if (child.type === vue_cjs_prod.Comment) {
      return false;
    }
    if (child.type === vue_cjs_prod.Fragment && !ensureValidVNode(child.children)) {
      return false;
    }
    return true;
  }) ? vnodes : null;
...
function useMemo(getterOrOptions) {
  const computedValueRef = vue_cjs_prod.computed(getterOrOptions);
  const valueRef = vue_cjs_prod.ref(computedValueRef.value);
  vue_cjs_prod.watch(computedValueRef, (value) => {
...
function isMounted() {
  const isMounted2 = vue_cjs_prod.ref(false);
  vue_cjs_prod.onMounted(() => {
    isMounted2.value = true;
  });
  return vue_cjs_prod.readonly(isMounted2);
}
const formItemInjectionKey = createInjectionKey("n-form-item");
function useFormItem(props, { defaultSize = "medium", mergedSize, mergedDisabled } = {}) {
  const NFormItem = vue_cjs_prod.inject(formItemInjectionKey, null);
  vue_cjs_prod.provide(formItemInjectionKey, null);
  const mergedSizeRef = vue_cjs_prod.computed(mergedSize ? () => mergedSize(NFormItem) : () => {
    const { size } = props;
    if (size)
      return size;
    if (NFormItem) {
  ...
  const mergedDisabledRef = vue_cjs_prod.computed(mergedDisabled ? () => mergedDisabled(NFormItem) : () => {
  ...
  const mergedStatusRef = vue_cjs_prod.computed(() => {
    const { status } = props;
    if (status)
      return status;
...
function useTheme(resolveId, mountId, style2, defaultTheme, props, clsPrefixRef) {
  ...
  const NConfigProvider = vue_cjs_prod.inject(configProviderInjectionKey, null);
  if (style2) {
    const mountStyle = () => {
    ...
    if (ssrAdapter2) {
      ...
      vue_cjs_prod.onBeforeMount(mountStyle);
    }
  }
  const mergedThemeRef = vue_cjs_prod.computed(() => {
    var _a;
...
function useConfig(props = {}, options = {
  ...
  return {
    ...
    mergedBorderedRef: vue_cjs_prod.computed(() => {
      var _a, _b;
    ...
    mergedClsPrefixRef: vue_cjs_prod.computed(() => {
    ...
    namespaceRef: vue_cjs_prod.computed(() => NConfigProvider === null || NConfigProvider === void 0 ? void 0 : NConfigProvider.mergedNamespaceRef.value)
  };
}
...
function useThemeClass(componentName, hashRef, cssVarsRef, props) {
  ...
  const mergedThemeHashRef = (_a = vue_cjs_prod.inject(configProviderInjectionKey, null)) === null || _a === void 0 ? void 0 : _a.mergedThemeHashRef;
  const themeClassRef = vue_cjs_prod.ref("");
  const ssrAdapter2 = useSsrAdapter();
  let renderCallback;
...
const NIconSwitchTransition = vue_cjs_prod.defineComponent({
  name: "BaseIconSwitchTransition",
  setup(_, { slots }) {
    const isMountedRef = isMounted();
    return () => vue_cjs_prod.h(vue_cjs_prod.Transition, { name: "icon-switch-transition", appear: isMountedRef.value }, slots);
  }
});
const NFadeInExpandTransition = vue_cjs_prod.defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      const type = props.group ? vue_cjs_prod.TransitionGroup : vue_cjs_prod.Transition;
      return vue_cjs_prod.h(type, {
...
const NBaseLoading = vue_cjs_prod.defineComponent({
  name: "BaseLoading",
  props: {
    clsPrefix: {
      type: String,
  ...
  setup(props) {
    useStyle("-base-loading", style$2, vue_cjs_prod.toRef(props, "clsPrefix"));
  },
  render() {
    const { clsPrefix, radius, strokeWidth, stroke, scale } = this;
    const scaledRadius = radius / scale;
    return vue_cjs_prod.h("div", { class: `${clsPrefix}-base-loading`, role: "img", "aria-label": "loading" }, vue_cjs_prod.h(NIconSwitchTransition, null, {
      default: () => this.show ? vue_cjs_prod.h("div", { key: "icon", class: `${clsPrefix}-base-loading__transition-wrapper` }, vue_cjs_prod.h("div", { class: `${clsPrefix}-base-loading__container` }, vue_cjs_prod.h("div", { class: `${clsPrefix}-base-loading__container-layer` }, vue_cjs_prod.h("div", { class: `${clsPrefix}-base-loading__container-layer-left` }, vue_cjs_prod.h("svg", { class: `${clsPrefix}-base-loading__svg`, viewBox: `0 0 ${2 * scaledRadius} ${2 * scaledRadius}`, xmlns: "http://www.w3.org/2000/svg", style: { color: stroke } }, vue_cjs_prod.h("circle", { fill: "none", stroke: "currentColor", "stroke-width": strokeWidth, "stroke-linecap": "round", cx: scaledRadius, cy: scaledRadius, r: radius - strokeWidth / 2, "stroke-dasharray": 4.91 * radius, "stroke-dashoffset": 2.46 * radius }))), vue_cjs_prod.h("div", { class: `${clsPrefix}-base-loading__container-layer-patch` }, vue_cjs_prod.h("svg", { class: `${clsPrefix}-base-loading__svg`, viewBox: `0 0 ${2 * scaledRadius} ${2 * scaledRadius}`, xmlns: "http://www.w3.org/2000/svg", style: { color: stroke } }, vue_cjs_prod.h("circle", { fill: "none", stroke: "currentColor", "stroke-width": strokeWidth, "stroke-linecap": "round", cx: scaledRadius, cy: scaledRadius, r: radius - strokeWidth / 2, "stroke-dasharray": 4.91 * radius, "stroke-dashoffset": 2.46 * radius }))), vue_cjs_prod.h("div", { class: `${clsPrefix}-base-loading__container-layer-right` }, vue_cjs_prod.h("svg", { class: `${clsPrefix}-base-loading__svg`, viewBox: `0 0 ${2 * scaledRadius} ${2 * scaledRadius}`, xmlns: "http://www.w3.org/2000/svg", style: { color: stroke } }, vue_cjs_prod.h("circle", { fill: "none", stroke: "currentColor", "stroke-width": strokeWidth, "stroke-linecap": "round", cx: scaledRadius, cy: scaledRadius, r: radius - strokeWidth / 2, "stroke-dasharray": 4.91 * radius, "stroke-dashoffset": 2.46 * radius })))))) : vue_cjs_prod.h("div", { key: "placeholder", class: `${clsPrefix}-base-loading__placeholder` }, this.$slots)
    }));
  }
});
const base = {
...
`);
const NBaseWave = vue_cjs_prod.defineComponent({
  name: "BaseWave",
  props: {
    clsPrefix: {
      type: String,
  ...
  setup(props) {
    useStyle("-base-wave", style$1, vue_cjs_prod.toRef(props, "clsPrefix"));
    const selfRef = vue_cjs_prod.ref(null);
    const activeRef = vue_cjs_prod.ref(false);
  ...
  render() {
    ...
    return vue_cjs_prod.h("div", { ref: "selfRef", "aria-hidden": true, class: [
      `${clsPrefix}-base-wave`,
...
function useRtl(mountId, rtlStateRef, clsPrefixRef) {
  if (!rtlStateRef)
    return void 0;
  const ssrAdapter2 = useSsrAdapter();
  const componentRtlStateRef = vue_cjs_prod.computed(() => {
...
const Button = vue_cjs_prod.defineComponent({
  name: "Button",
  props: buttonProps,
  setup(props) {
    {
    ...
    const selfElRef = vue_cjs_prod.ref(null);
    const waveElRef = vue_cjs_prod.ref(null);
    const enterPressedRef = vue_cjs_prod.ref(false);
    const showBorderRef = useMemo(() => {
      return !props.quaternary && !props.tertiary && !props.secondary && !props.text && (!props.color || props.ghost || props.dashed) && props.bordered;
    });
    const NButtonGroup = vue_cjs_prod.inject(buttonGroupInjectionKey, {});
    ...
    const mergedFocusableRef = vue_cjs_prod.computed(() => {
    ...
    const cssVarsRef = vue_cjs_prod.computed(() => {
    ...
    const themeClassHandle = inlineThemeDisabled ? useThemeClass("button", vue_cjs_prod.computed(() => {
      let hash2 = "";
      const { dashed, type, ghost, text, color, round, circle, textColor, secondary, tertiary, quaternary, strong } = props;
      if (dashed)
        hash2 += "a";
    ...
    return {
      ...
      handleKeyup,
      handleClick,
      customColorCssVars: vue_cjs_prod.computed(() => {
        const { color } = props;
        if (!color)
          return null;
  ...
  render() {
    ...
    const children = resolveWrappedSlot(this.$slots.default, (children2) => children2 && vue_cjs_prod.h("span", { class: `${mergedClsPrefix}-button__content` }, children2));
    return vue_cjs_prod.h(Component, { ref: "selfElRef", class: [
      this.themeClass,
    ...
    ], tabindex: this.mergedFocusable ? 0 : -1, type: this.attrType, style: this.cssVars, disabled: this.disabled, onClick: this.handleClick, onBlur: this.handleBlur, onMousedown: this.handleMousedown, onKeyup: this.handleKeyup, onKeydown: this.handleKeydown }, this.iconPlacement === "right" && children, vue_cjs_prod.h(NFadeInExpandTransition, { width: true }, {
      default: () => resolveWrappedSlot(this.$slots.icon, (children2) => (this.loading || children2) && vue_cjs_prod.h("span", { class: `${mergedClsPrefix}-button__icon`, style: {
        margin: isSlotEmpty(this.$slots.default) ? "0" : ""
      } }, vue_cjs_prod.h(NIconSwitchTransition, null, {
        default: () => this.loading ? vue_cjs_prod.h(NBaseLoading, { clsPrefix: mergedClsPrefix, key: "loading", class: `${mergedClsPrefix}-icon-slot`, strokeWidth: 20 }) : vue_cjs_prod.h("div", { key: "icon", class: `${mergedClsPrefix}-icon-slot`, role: "none" }, children2)
      })))
    }), this.iconPlacement === "left" && children, !this.text ? vue_cjs_prod.h(NBaseWave, { ref: "waveElRef", clsPrefix: mergedClsPrefix }) : null, this.showBorder ? vue_cjs_prod.h("div", { "aria-hidden": true, class: `${mergedClsPrefix}-button__border`, style: this.customColorCssVars }) : null, this.showBorder ? vue_cjs_prod.h("div", { "aria-hidden": true, class: `${mergedClsPrefix}-button__state-border`, style: this.customColorCssVars }) : null);
  }
});
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div>`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(NButton), null, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Default`);
          } else {
            return [
              vue_cjs_prod.createTextVNode("Default")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(NButton), { type: "tertiary" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Tertiary `);
          } else {
            return [
              vue_cjs_prod.createTextVNode(" Tertiary ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(NButton), { type: "primary" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Primary `);
          } else {
            return [
              vue_cjs_prod.createTextVNode(" Primary ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(NButton), { type: "info" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Info `);
          } else {
            return [
              vue_cjs_prod.createTextVNode(" Info ")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(NButton), { type: "success" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Success `);
          } else {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(NButton), { type: "warning" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Warning `);
          } else {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(NButton), { type: "error" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Error `);
          } else {
      ...
      _push(`</div>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLayout, { cl: "" }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  const _component_Logos = __nuxt_component_0$2;
  const _component_PageView = _sfc_main$e;
  const _component_InputEntry = _sfc_main$d;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_Logos, { "mb-6": "" }, null, _parent));
  serverRenderer.exports.ssrRenderSuspense(_push, {
    fallback: () => {
      _push(`<div op50 italic><span animate-pulse>Loading...</span></div>`);
    },
    default: () => {
      _push(serverRenderer.exports.ssrRenderComponent(_component_PageView, null, null, _parent));
    },
    _: 1
  });
  _push(serverRenderer.exports.ssrRenderComponent(_component_InputEntry, null, null, _parent));
  _push(`</div>`);
}
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3]]);
...
const _sfc_main$3 = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    useColorMode();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "!outline-none" }, _attrs))}><div class="dark:i-carbon-moon i-carbon-sun"></div></button>`);
    };
  }
});
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$3;
  const _component_DarkToggle = _sfc_main$3;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    text: "xl gray4",
    "m-5": "",
    flex: "",
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_DarkToggle, null, null, _parent));
  _push(`</div>`);
}
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<main${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "py-20 px-10 text-center" }, _attrs))}>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]);
